export function acceptBookingTemplate(customerName, workerName, serviceName, bookingDate) {
  ...
  <div style="max-width:600px; margin:0 auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
    ...
    <div style="background:linear-gradient(135deg,#2563EB,#7C3AED); padding:32px 40px; text-align:center;">
      ...
      <p style="color:rgba(255,255,255,0.85); font-size:15px; margin:6px 0 0 0;">
        Your service has been confirmed by the worker
      </p>
    ...
    <div style="padding:36px 40px 28px 40px;">
      ...
      <p style="color:#4a5568; font-size:15px; margin:0 0 24px 0;">
        Great news! <strong>${workerName}</strong> has accepted your booking request.
        You're all set for your upcoming service.
      </p>
      ...
      <table style="width:100%; border-collapse:collapse; margin:16px 0 20px 0;">
        ...
        <tr>
          <td style="padding:10px 16px 10px 0; color:#718096; font-size:13px; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; width:35%; border-bottom:1px solid #f0f4f8;">
            Service Name
          </td>

          <td style="padding:10px 0; color:#1a202c; font-size:15px; font-weight:600; border-bottom:1px solid #f0f4f8;">
            ${serviceName}
          </td>
        </tr>
        ...
        <tr>
          <td style="padding:10px 16px 10px 0; color:#718096; font-size:13px; font-weight:600; text-transform:uppercase; letter-spacing:0.5px; width:35%;">
            Status
          </td>

          <td style="padding:10px 0; color:#1a202c; font-size:15px; font-weight:600;">
            <span style="display:inline-block; background:#dcfce7; color:#166534; font-weight:600; font-size:13px; padding:4px 16px; border-radius:20px; margin-top:8px;">
              ✅ Confirmed
            </span>
          </td>
        </tr>
      ...
      <!-- What's Next -->
      <p style="font-size:15px; color:#1a202c; margin:0 0 4px 0;">
        <strong>📌 What's next?</strong>
      </p>

      <ul style="color:#4a5568; font-size:14px; padding-left:20px; margin:8px 0 0 0; line-height:1.8;">
    ...
    <div style="background:#f7fafc; padding:20px 40px; text-align:center; border-top:1px solid #e2e8f0;">
      ...
      <p style="color:#a0aec0; font-size:13px; margin:4px 0;">
        &copy; 2026 <strong>Quick Hire</strong>. All rights reserved.
      </p>

      <p style="font-size:12px; color:#cbd5e0; margin:6px 0 0 0;">
        Need help?
        <a

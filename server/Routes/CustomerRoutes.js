...
import {cancellbooking,updateProfile,getCurrentCustomerReservations, getCurrentCustomerData, addNewPassword ,login, logout, register, sendForgotPwOtp, verifyForgotPWOtp, becomeWorker, verifybecomeWorkerOTP, createWorker, addComment, addReservation } from '../Contollers/customerController.js';
...
customerRoute.post('/updateProfile',userAuth,updateProfile);
customerRoute.post('/cancellbooking',cancellbooking);
